...
<body>
    <div class="app" id="app-shell">
        ...
        <nav class="app__nav" aria-label="Navegación principal">
            <div class="nav-group">
                <div class="nav-group__label">Inicio</div>
            ...
            <div class="nav-group">
                <div class="nav-group__label">Accesos</div>
                <a href="{{ route('desktop.usuarios') }}" class="nav-item {{ request()->routeIs('desktop.usuarios') || request()->routeIs('desktop.roles') || request()->routeIs('desktop.permisos') || request()->routeIs('desktop.bitacora') ? 'is-active' : '' }}">
                    <span class="nav-item__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="M15.5 4.5 19 8"/><path d="m18 2 4 4"/></svg></span>
                    <span class="nav-item__label">Accesos</span>
                </a>
            </div>

            <div class="nav-group">
                <div class="nav-group__label">Comercio</div>
                <a href="{{ route('desktop.operacion.gestion_configuraciones.index') }}" class="nav-item {{ request()->routeIs('desktop.operacion.gestion_configuraciones.*') && !request()->routeIs('desktop.operacion.gestion_configuraciones.clientes.*') ? 'is-active' : '' }}">
                ...
                <a href="{{ route('desktop.operacion.catalogo_comercial.index') }}" class="nav-item {{ request()->routeIs('desktop.operacion.catalogo_comercial.*') ? 'is-active' : '' }}">
                    ...
                    <span class="nav-item__label">Catálogo</span>
                </a>
                @if($desktopUser?->tienePermiso('etiquetas.formatos.ver'))
                    <a href="{{ route('desktop.operacion.etiquetas.index') }}" class="nav-item {{ request()->routeIs('desktop.operacion.etiquetas.*') ? 'is-active' : '' }}">
                        <span class="nav-item__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7"/><path d="M7 3h10v8H7z"/><path d="M9 14h6"/></svg></span>
                        <span class="nav-item__label">Etiquetas</span>
                    </a>
                @endif
                @if($desktopUser?->tienePermiso('cliente.ver'))
                    <a href="{{ route('desktop.operacion.gestion_configuraciones.clientes.index') }}" class="nav-item {{ request()->routeIs('desktop.operacion.gestion_configuraciones.clientes.*') ? 'is-active' : '' }}">
                ...
                <a href="{{ route('pos.index') }}" class="nav-item {{ request()->routeIs('pos.*') ? 'is-active' : '' }}">
                    ...
                    <span class="nav-item__label">Caja</span>
                </a>
