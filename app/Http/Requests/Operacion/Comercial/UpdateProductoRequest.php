...
class UpdateProductoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'prd_codigo' => [
                ...
                'string',
                'max:40',
                Rule::unique('tbl_productos_prd', 'prd_codigo')
                    ->ignore($id, 'prd_id')
            ...
            'prd_codigo_barras' => [
                ...
                'string',
                'max:80',
                Rule::unique('tbl_productos_prd', 'prd_codigo_barras')
                    ->ignore($id, 'prd_id')
                    ->where(fn ($query) => $query->where('prd_deleted', false)),
            ],
            ...
            'prd_nombre' => [
                ...
                'string',
                'max:180',
                Rule::unique('tbl_productos_prd', 'prd_nombre')
                    ->ignore($id, 'prd_id')
                    ->where(fn ($query) => $query->where('prd_deleted', false)),
            ],
            ...
            'almacen_ids' => ['required', 'array', 'size:1'],
    ...
    public function messages(): array
    {
        return [
            ...
            'almacen_ids.required' => 'Debes seleccionar un almacén para el producto.',
            'almacen_ids.size' => 'Cada producto debe pertenecer a un solo almacén.',
