...
class UpdateProveedorRequest extends FormRequest
{
    ...
    {
        $proveedorId = (int) $this->route('proveedor');
        ...
        return [
            'prv_nombre_empresa' => [
                ...
                'string',
                'max:180',
                Rule::unique('tbl_proveedores_prv', 'prv_nombre_empresa')
                    ->ignore($proveedorId, 'prv_id')
                    ->where(fn ($query) => $query->where('prv_deleted', false)),
            ],
            ...
            'prv_rfc' => [
                ...
                'string',
                'max:13',
                Rule::unique('tbl_proveedores_prv', 'prv_rfc')
                    ->ignore($proveedorId, 'prv_id')
                    ->where(fn ($query) => $query->where('prv_deleted', false)),
            ],
