...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('desktop/operacion/inventario')->name('desktop.operacion.inventario.')->group(function () {
        ...
        Route::post('/existencias-negativas/ajustar-cero', [OperacionInventarioController::class, 'ajustarExistenciasNegativasCero'])->name('existencias_negativas.ajustar_cero')->middleware('permiso:inventario_base.ver');
