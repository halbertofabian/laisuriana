...
var y = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-C1aScSTo-KFZJ2H4I.js")).iosTransitionAnimation : (await import("./p-DIE4pXMl-BPAWKSPO.js")).mdTransitionAnimation;
};
var h = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K2PJX6H4.js.map
